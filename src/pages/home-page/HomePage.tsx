      ...
      <div className="home-page">
        <div className="variants">
          <div
            ...
            className={variant ? "first-variant-active" : "first-variant"}
          ></div>
          <div
            onClick={changeSecondVariant}
            className={variant ? "second-variant" : "second-variant-active"}
          ></div>
        </div>
        <div className="cards">
          {getItems?.map((page) =>
            page.items.map((i) => (
              <Card
                key={i.id}
                {...i}
                secondV={secondVariant}
                changeSecondV={changeSecondVariant}
                firstV={variant}
              />
            ))
          )}
        ...
        <button
          onClick={scrollToTop}
          className={visible ? "scroll-to-top" : "none"}
        >
        ...
        <button
          ...
          onClick={handleClickPageCount}
          className={currentPage === 10 ? "none" : "show-more"}
        >
          Показать еще
        </button>
      </div>
